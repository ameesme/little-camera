...
// XIAO ESP32-S3 Sense (OV2640 on the B2B connector) camera pins.
// All of these live on the B2B connector — no overlap with the
// Xiao_Shutter carrier nets on the castellated pads.
