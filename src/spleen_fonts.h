...
// Spleen bitmap fonts by Frederic Cambus
// https://github.com/fcambus/spleen
// License: BSD-2-Clause

#include <stdint.h>

// spleen6x12 font - 6x12
// Printable ASCII (32-126)

constexpr int SPLEEN6X12_WIDTH = 6;
constexpr int SPLEEN6X12_HEIGHT = 12;
constexpr int SPLEEN6X12_FIRST_CHAR = 32;
constexpr int SPLEEN6X12_LAST_CHAR = 126;

static const uint8_t SPLEEN6X12_DATA[][12] = {
    ...
    {0x00, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  // 39: 'apostrophe'
    ...
    {0x80, 0x80, 0x40, 0x40, 0x20, 0x20, 0x10, 0x10, 0x08, 0x08, 0x00, 0x00},  // 92: 'backslash'
...
static inline const uint8_t* spleen6x12_getGlyph(char c) {
    if (c < SPLEEN6X12_FIRST_CHAR || c > SPLEEN6X12_LAST_CHAR) {
        return SPLEEN6X12_DATA[0];  // Return space for out-of-range
    }
    return SPLEEN6X12_DATA[c - SPLEEN6X12_FIRST_CHAR];
}

// spleen8x16 font - 8x16
// Printable ASCII (32-126)

constexpr int SPLEEN8X16_WIDTH = 8;
constexpr int SPLEEN8X16_HEIGHT = 16;
constexpr int SPLEEN8X16_FIRST_CHAR = 32;
constexpr int SPLEEN8X16_LAST_CHAR = 126;

static const uint8_t SPLEEN8X16_DATA[][16] = {
...
static inline const uint8_t* spleen8x16_getGlyph(char c) {
    if (c < SPLEEN8X16_FIRST_CHAR || c > SPLEEN8X16_LAST_CHAR) {
        return SPLEEN8X16_DATA[0];  // Return space for out-of-range
    }
    return SPLEEN8X16_DATA[c - SPLEEN8X16_FIRST_CHAR];
}